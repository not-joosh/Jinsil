export const LoadingIcon = () => {
    return (
        <>
            <svg className = "" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{margin: 'auto', backgroundColor: "rgba(26, 30, 35, 0.90)", display: 'block', width: '100vw', height: '100vh', zIndex: 500,
